...
import { createSellerHandler, listSellersHandler, getSellerByIdHandler, updateSellerHandler, resetSellerPasswordHandler, deactivateSellerHandler, activateSellerHandler, hardDeleteSellerHandler, } from '../controllers/sellers.controller.js';
const router = Router();
