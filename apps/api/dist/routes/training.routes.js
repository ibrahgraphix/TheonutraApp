...
import { listCategoriesHandler, createCategoryHandler, updateCategoryHandler, listMaterialsByCategoryHandler, getMaterialHandler, createMaterialHandler, updateMaterialHandler, deactivateMaterialHandler, } from '../controllers/training.controller.js';
const router = Router();
