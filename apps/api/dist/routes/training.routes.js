...
import { listCategoriesHandler, createCategoryHandler, updateCategoryHandler, deleteCategoryHandler, listMaterialsByCategoryHandler, getMaterialHandler, createMaterialHandler, updateMaterialHandler, deactivateMaterialHandler, hardDeleteMaterialHandler, } from '../controllers/training.controller.js';
const router = Router();
