...
import { getRanks, getMyRankProgress, promoteDistributorHandler, } from '../controllers/ranks.controller.js';
const router = Router();
...
router.patch('/:distributorId/promote', authMiddleware, requireStaff, validate(PromoteDistributorSchema), promoteDistributorHandler);
export default router;
//# sourceMappingURL=ranks.routes.js.map