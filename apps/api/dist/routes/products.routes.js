...
import { listProductsByCountryHandler, getProductByIdHandler, createProductHandler, updateProductHandler, deactivateProductHandler, } from '../controllers/products.controller.js';
const router = Router();
