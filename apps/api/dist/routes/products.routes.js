...
import { listProductsByCountryHandler, getProductByIdHandler, createProductHandler, updateProductHandler, deactivateProductHandler, activateProductHandler, listProductsForAdminHandler, getProductForAdminHandler, } from '../controllers/products.controller.js';
const router = Router();
