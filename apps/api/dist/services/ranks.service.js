 ...
 */
export async function getPersonalPV(distributorId, month) {
    const now = new Date();
    let startStr;
    let endStr;
    if (month) {
 ...
 */
export async function getTeamPV(distributorId, month) {
 ...
 */
export async function getMyRank(distributorId) {
    ...
    const currentRankRow = profile.ranks;
 ...
 */
export async function getRankProgress(distributorId) {
 ...
 */
export async function promoteDistributor(distributorId, newRankId, staffId) {
    // Verify rank exists
