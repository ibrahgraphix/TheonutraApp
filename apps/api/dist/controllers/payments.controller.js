 ...
 */
export async function submitBankPaymentHandler(req, res, next) {
    try {
        if (!req.user) {
 ...
 */
export async function submitMobileMoneyPaymentHandler(req, res, next) {
    try {
        if (!req.user) {
            throw new ApiError(401, 'Unauthorized');
        }
 ...
 */
export async function listPendingPaymentsHandler(_req, res, next) {
    try {
 ...
 */
export async function confirmPaymentHandler(req, res, next) {
    try {
        if (!req.user) {
            throw new ApiError(401, 'Unauthorized');
        }
