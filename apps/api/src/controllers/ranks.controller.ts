...
import { PromoteDistributorInput } from '../schemas/ranks.schema.js';
 ...
 */
export async function getMyRankProgress(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
 ...
 */
export async function promoteDistributorHandler(
  req: Request,
  res: Response,
  next: NextFunction,
): Promise<void> {
  try {
    ...
    const { newRankId } = req.body as PromoteDistributorInput;
