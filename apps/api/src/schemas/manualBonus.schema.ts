...
export const AwardManualBonusSchema = z.object({
  ...
  bonusCategory: z.enum(['leadership', 'rank_achievement', 'monthly_performance', 'other'] as const, {
    message: "bonusCategory must be 'leadership', 'rank_achievement', 'monthly_performance', or 'other'",
  }),
